...
CREATE TABLE IF NOT EXISTS sequence_table ("id" VARCHAR, "datasources" BIGINT, "datafeeds" BIGINT, "parser_info" BIGINT, "topologies" BIGINT, "topology_components" BIGINT, "tag" BIGINT, "notifierinfos" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
